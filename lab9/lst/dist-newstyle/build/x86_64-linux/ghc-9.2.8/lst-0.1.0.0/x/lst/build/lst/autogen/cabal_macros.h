...
/* package lst-0.1.0.0 */
#ifndef VERSION_lst
#define VERSION_lst "0.1.0.0"
#endif /* VERSION_lst */
#ifndef MIN_VERSION_lst
#define MIN_VERSION_lst(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lst */
...
#define CURRENT_COMPONENT_ID "lst-0.1.0.0-inplace-lst"
